...
## 1. Five principles (the constitution — everything else is a capability)
...
.harness/              gitignored: state.json, scratch/ (discovery.md, probes/), runtime/ (leases, baselines, logs, reviews, session)
...
reuse scan · disposable probes · independent challenge (planner-triggered, one round, never
