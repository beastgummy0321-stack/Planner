...
1. Run the `attach` command you were given, verbatim, before anything else. Its output is your issue: objective, done criteria, verify commands, touch globs, and the exact Bash commands you may run.
...
5. Final report: files changed, verify output, open concerns. Nothing about architecture, no new docs, no rules.
