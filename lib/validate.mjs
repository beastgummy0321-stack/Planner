...
// opts.materialized: require every module root/public and legacy facade to exist on disk.
// The manifest is the desired topology: a module may be declared in /carve before its first issue creates it,
// so existence is soft until `integrate feature`, where the topology must be real.
