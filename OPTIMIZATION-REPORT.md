...
歷史紀錄（非開工必讀）：2026-09-16 的 v3 遷移。現行規則見 WORKFLOW.md、行為見 SPEC.md；下列驗證數字只屬於當次執行。

基準：01b1a09b85c1c5b43e86bec213056458973577c1（2.9.1）。該輪當時僅完成本機 checkout；安裝狀態請以各主機 plugin list 為準。
